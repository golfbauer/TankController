    ...
    public class UIGroupEditor : TankComponentEditor
    {
        ...
        private void ShowUIElementsGUI()
        {
            ...
            for (int i = 0; i < _uiElements.arraySize; i++)
            {
                ...
                UIElement element =
                    _uiElements.GetArrayElementAtIndex(i).objectReferenceValue as UIElement;
        ...
        private void UIElementGUI(UIElement element, int index)
        {
            ...
            if (foldout)
            {
                ...
                UIElementType elementType = (UIElementType)
                    EditorGUILayout.EnumPopup(GeneralMessages.Type, element.type);
                EditorGUILayout.ObjectField(
                    GeneralMessages.Transform,
                    elementGameObject.transform,
                    typeof(Transform),
                    true
                );
                element.DisplayGUI();
        ...
        private void CreateUIElementGUI()
        {
            if (GUILayout.Button(GeneralMessages.Add))
            {
                ...
                _uiElements.GetArrayElementAtIndex(_uiElements.arraySize - 1).objectReferenceValue =
                    uiElement;
            }
        }
        ...
        public override void ShowDenyAccessMessage()
        {
