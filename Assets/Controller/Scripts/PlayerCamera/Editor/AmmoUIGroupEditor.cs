    ...
    public class AmmoUIGroupEditor : UIGroupEditor
    {
        ...
        public override void SetUpGUI()
        {
            ...
            List<AmmunitionType> ammunitionTypes = (
                (AmmunitionManager)_ammunitionManager.objectReferenceValue
            ).AmmunitionTypes;

            int index =
                _ammunitionType.objectReferenceValue == null
                    ? 0
                    : ammunitionTypes.IndexOf((AmmunitionType)_ammunitionType.objectReferenceValue);

            _ammunitionType.objectReferenceValue = ammunitionTypes[
