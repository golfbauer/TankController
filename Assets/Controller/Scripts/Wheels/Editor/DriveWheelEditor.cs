...
namespace Controller.Scripts.Wheels.DriveWheel
{
    [CustomEditor(typeof(DriveWheel))]
    [CanEditMultipleObjects]
    public class DriveWheelEditor : WheelEditor
    {
        ...
        private void OnEnable()
        {
            ...
            transform = ((DriveWheel)target).gameObject.transform;
