...
namespace Controller.Scripts.Turret.Editor
{
    ...
    public class GunEditor : TankComponentEditor
    {
        ...
        private void OnEnable()
        {
            ...
            _mainGunBoxColliderChangeManually = serializedObject.FindProperty(
            ...
            _mantletBoxColliderChangeManually = serializedObject.FindProperty(
        ...
        private void Initialize()
        {
            ...
            {
                var verticalRotation = transform.gameObject.AddComponent<VerticalRotation>();
            ...
            try
            {
                var spawnPoint = _mainGun.transform.Find("Spawn Point").gameObject;
            }
        ...
        public override void SetUpGUI()
        {
            ...
            if (_mainGunUseBoxCollider.boolValue)
            {
                ...
                {
                    var boxCollider = _mainGun.GetComponent<BoxCollider>();
                    if (boxCollider != null)
                    {
        ...
        {
            var mainGunTransform = transform.Find("Main Gun");
