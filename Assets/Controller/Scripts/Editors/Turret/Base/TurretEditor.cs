...
namespace Controller.Scripts.Editors.Turret.Base
{
    ...
    public class TurretEditor : TankComponentEditor
    {
        ...
        private void OnEnable()
        {
            ...
            _turretMaterials =
                serializedObject.FindProperty("turretMaterials");
            ...
            _boxColliderChangeManually =
                serializedObject.FindProperty("boxColliderChangeManually");
            _boxColliderSize =
                serializedObject.FindProperty("boxColliderSize");
            _boxColliderCenter =
                serializedObject.FindProperty("boxColliderCenter");

            _useAmmunitionManager =
                serializedObject.FindProperty("useAmmunitionManager");
            _useRotationManager =
                serializedObject.FindProperty("useRotationManager");
        ...
        private void Initialize()
        {
            ...
            if (!transform.GetComponent<AmmunitionManager>() &&
                _useAmmunitionManager.boolValue)
            {
                AmmunitionManager ammunitionManager =
                    transform.AddComponent<AmmunitionManager>();
                try
                {
                    ammunitionManager.spawnPoint = transform
                        .Find("Mantlet/Main Gun/Spawn Point").gameObject;
                }
                catch (NullReferenceException)
                {
                    Debug.LogWarning(
                        "Couldn't find the spawn point, please assign manually.");
                }
            }
        ...
        public override void SetUpGUI()
        {
            ...
            GUIUtils.PropFieldGUI(_useAmmunitionManager,
                TurretMessages.UseAmmunitionManager);
            GUIUtils.PropFieldGUI(_useRotationManager,
                TurretMessages.UseRotationManager);
            GUIUtils.PropFieldGUI(_useCollisionManager,
                TurretMessages.UseCollisionManager);
        ...
        private void ShowCollider()
        {
            ...
            {
                GUIUtils.PropFieldGUI(_boxColliderChangeManually,
                ...
                GUIUtils.PropFieldGUI(_colliderMeshes,
        ...
        public override void BulkUpdateComponents()
        {
            ...
            if (_useBoxCollider.boolValue)
            {
                ...
                UpdateBoxCollider(transform, _boxColliderCenter,
                    _boxColliderSize);
                return;
            }
