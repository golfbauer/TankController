...
namespace Controller.Scripts.Editors.Wheels.SupportWheel
{
    ...
    public class CreateSupportWheelEditor : CreateWheelEditor
    {
        ...
        public override void SetUpGUI()
        {
            ...
            GUIUtils.PropFieldGUI(_rightWheelTorqueProp,
            ...
            GUIUtils.PropFieldGUI(_leftWheelRotationProp,
                WheelMessages.EulerRotation);
            GUIUtils.PropFieldGUI(_leftWheelTorqueProp,
                WheelMessages.TorqueDirection);
            ...
            GUIUtils.SliderGUI(_wheelDistanceProp, 0.1f, 5f,
                WheelMessages.Distance);
            GUIUtils.SliderGUI(_wheelSpacingProp, 0.1f, 5f,
        ...
        private void CreateWheel(bool isLeft, int i)
        {
            ...
            var wheel = new GameObject(wheelName + i)
            {
                ...
                {
                    parent = transform,
                    localPosition = new Vector3(wheelDistance, 0,
