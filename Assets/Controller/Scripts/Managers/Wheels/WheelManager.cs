...
namespace Controller.Scripts.Managers.Wheels
{
    public class WheelManager : MonoBehaviour
    {
        ...
        {
            _movementManager =
                transform.parent.GetComponent<MovementManager>();
        ...
        {
            leftTargetSpeed = _movementManager.GetLeftTrackSpeed() /
                (2.0f * wheelRadius * Mathf.PI) * 360.0f * Mathf.Deg2Rad;
            rightTargetSpeed = _movementManager.GetRightTrackSpeed() /
                (2.0f * wheelRadius * Mathf.PI) * 360.0f * Mathf.Deg2Rad;
