    ...
    public abstract class BaseProjectile : MonoBehaviour
    {
        ...
        protected virtual void OnCollisionEnter(Collision collision)
        {
            ...
            CollisionManager collisionManager =
                hitObject.GetComponent<CollisionManager>();
        ...
        protected abstract void HandleTankCollision(Collision collision,
            GameObject hitTank);

        protected abstract void HandleGenericCollision(Collision collision,
        ...
        protected virtual Vector3 GetHitPoint(Vector3 hitPoint)
        {
            ...
            if (Physics.Raycast(rayStart, rayDirection,
        ...
        protected virtual ArmorSection GetArmorSection(GameObject hitTank,
            Collision collision)
        {
            CollisionManager collisionManager =
                hitTank.GetComponent<CollisionManager>();
            Vector3 actualHit = GetHitPoint(collision.contacts[0].point);
            return collisionManager.HandleImpact(actualHit,
                hitTank.transform);
        }
        ...
        protected virtual void ApplyAirResistance()
        {
            ...
            Vector3 dragForce = -0.5f * C_d * rho * A * v * v *
